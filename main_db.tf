...
variable "key_pair" { default = "Limor Gargir-Alpert" }
...
variable "ssh_key_path" { default = "/Users/c5215768/.ssh/id_rsa" } # On macOS, it is `/Users/<your_user_name>/.ssh/id_rsa`; on Windows `C:\Users\<your_user_name>\.ssh\id_rsa`
